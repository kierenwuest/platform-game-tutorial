...
//* Now put them in the constructor to keep things neater
let gameFrame = 0;

class Entity { // classes are new version of older 'prototypes' which do the same thing.
    constructor(){
        this.image = new Image();
        this.image.src = 'images/HummingBird.png';
    ...
    draw(){ //taking what we would draw int he animation loop anf d putting it in here as a method too
        ctx.drawImage(this.image, this.frame*this.spriteWidth , 0 , this.spriteWidth , this.spriteHeight , this.x,this.y,this.width,this.height); //! ( crop 4 , draw 4)
    } 
}
